      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          ...
          <div className="bg-white p-8 border-4 border-black text-center shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
            ...
            <h3 className="text-2xl font-bold mb-4">Buat Sesi Q&A</h3>
            <p className="text-lg">
          ...
          <div className="bg-white p-8 border-4 border-black text-center shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
            ...
            <h3 className="text-2xl font-bold mb-4">Viewers Bertanya</h3>
            <p className="text-lg">
          ...
          <div className="bg-white p-8 border-4 border-black text-center shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
            ...
            <h3 className="text-2xl font-bold mb-4">Tampilkan di Stream</h3>
            <p className="text-lg">
